...
** Fix
- Restore the Publisher: field
- Add Place, Edition, and Subtitle
- Fix Authors to be "& First Last" or "First Last, First Last, & First Last"
- Fix up the generation of the bib table.
