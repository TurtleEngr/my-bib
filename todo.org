...
- The archive.vn links in AltLink are mostly broken. Replace them with
  ...
  1. Go to https://archive.org/web/ (the Wayback Machine at Internet Archive)
...
**** Using Chrome extension
  - Add "Wayback Machine" Chrome extension
  ...
  2. Enter the orginal Link url
  3. Click on the extension, then click on "Save Page Now" or "Newest"
...
*** For Type: book, Fixup Date, Publisher, Link
  ...
  9. Shorten amazon links, if they still work. For example:
    - Old Link: https://www.amazon.com/Lost-Cause-Cory-Doctorow-ebook/dp/B0BQGGP2XT
    - New Link: https://www.amazon.com/dp/B0BQGGP2XT
