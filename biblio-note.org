...
** Id: bean-01
See also: thomson-01, thomson-02

** Id: becker-01
Gavin de Becker wrote the book The Gift of Fear
https://www.amazon.com/gp/product/B0036Z9U2A/
Trust your intuition.

Trust what is best for you. It will be good for others too. (I.e. you
can only control yourself.)

Actually it is is good that AI is sowing distrust; we need to question
what is "real" more.

Solving the problem of large institutions. He likes companies with no
more than 600 people. He thinks 300 is the best community size.

In larger groups, most relationships are temporary.

Best way to govern is with "Subsidiarity" - govern at the lowest
possible level.
...
- Some missing articles can be found in Internet Archive or OpEdNews
  (using google.com)
** Id: braga-01
- I took a guess at the date of the article. It is somewhere between
  2022 and 2025. (Why are dates left off of web pages? Maybe the
  thought is that the information will be ignored a few years after
  the date, so don't add a date.)
...
** Id: chenoweth-01
- See also: chenoweth-02
** Id: chenoweth-02
- See also: chenoweth-01
** Id: chiang-02
...
** Id: gibbs-01
- To avoid confirmation bias, I now preface all my serious prompts
  with these directions.

  In all your responses, please focus on substance over praise. Skip
  unnecessary compliments, engage critically with my ideas, question
  my assumptions, identify my biases, and offer counterpoints when
  relevant. Don’t shy away from disagreement, and ensure that any
  agreements you have are grounded in reason and evidence. Also, give
  examples and sources.

  When writing your response, please ensure you include the following
  information: 1. A neutral, unbiased view of the request, unfiltered
  by your desire to be a helpful and positive assistant. 2. A devil’s
  advocate view, pointing out any logical counterpoints or things that
  I have overlooked. 3. An encouraging, positive view of the request.
...
- Prompt:
  ...
  Output an overview of every single dimension of my request.
  Find points of uncertainty.
  Then, ask me as many clarifying questions as possible.

- or

  Output an overview of every single dimension of my request.
  Find points of uncertainty.
  Then, ask me at most 7 of your most relevant clarifying questions.
...
** Id: gutmann-01
- <i>"The evidence is clear that <b>boring management</b>
  matters."</i>--Raffaella Sadun{gutmann-01}

- Leader selection mistake: People often pick leaders because they
  make for a good "story."  Excellent leaders have boring stories,
  because they have avoided the conflicts that make for a good
  story.

<blockquote>We see leadership potentils in people who:
...
<blockquote>"since we reward people who are good in crises (and
ignore people who are such good manager that there are very few
crises), [people] soon learn to seek out (or reframe situations as)
crises."--Keith Grint </blockquote>
...
** Id: html-01
- Inspired by: https://web.archive.org/web/20131130130322/http://motherfuckingwebsite.com/
- Domain registered:
  - 2025-03-29
  - State: Kharkiv
  - Country: UA (Ukraine)
...
** Id: keen-01
Link: https://www.youtube.com/watch?v=PUO51DoSEqk
Transscript:  https://moria.whyayh.com/rel/archive/article/culture/financial-crash-expert_2026-04-06.html
Local video: https://moria.whyayh.com/rel/archive/video/ThirdParty/culture/Financial_Crash_Expert_2026-04-06.mp4

*** 5 Scenarios
+ Scenario 1: What Happens If Iran Is Destroyed
  + Only possible if nukes are used, by Israel or US

+ Scenario 2: The Fallout If Gulf Infrastructure Collapses
  + Iran attacks all of the Arab nation's power and desalination plants.

+ Scenario 3: The Samson Doctrine--And When It's Used
  + Trump or Israel are losing, the just end everything. Launch nukes.
  + "I sat with um a few nuclear experts and one of the things that
    was shocking, I learned if the United States wanted to launch a
    nuclear weapon today, it is one person's decision.  I heard that
    Trump can actually just make that decision.  He can make the
    decision on his own. He doesn't need to consult Congress or
    anybody else. He has someone who walks around with a briefcase
    that has the nuclear codes in it at any moment."

+ Scenario 4: Could Iran Neutralize Israel's Nukes
  + This is the "best" scenario, because only conventional weapons
    will be used. And things are more "balanced."

+ Scenario 5: What Changes If Iran Goes Nuclear
  + This brings about MAD balance. But this is more dangerous than
    scenario 3.

** Id: kelly-01
- An introductory toolkit for mutual aid organizing—from starting a
  group to sustaining it for the long haul

- https://indivisiblepv.info/2025/02/some-actions-that-are-not-protesting-or-voting/
...
** Id: hughes-01
- The problem with disinformation? It is like the boy who cried wolf.
  We be come numb to it and stop reacting. A new normal of not caring
  and not call out the disinformation.

- Her suggesting, call out people spreading disinformation. Let them
  know their behavior is "weird" not normal. This is not "normal" for
  the "in-crowd."
...
** Id: kauth-01
+ What happened to the group they started in Ashland? Covid blew-up
  the group.
  + Source: https://www.youtube.com/watch?v=7UaWVpJuyKw
+ The MKP-USA kicked out the LKS (Lodge Keepers Society) was kicked
  out of Mankind Project, because they were accused of
  misappropriation of traditional indigenous practices. The
  Purification and Renewal Ceremony.
  + Source: https://www.wvmkp.org/2022-2/sep-2022/lks-update/
+ The Shadow in the MKP-USA. Politically Correct, Woke, Cancel Culture
  + Source: https://billkauth.com/
...
** Id: landemore-01
Dr. Landemore is a political theorist at Yale and the author of
...
58:19 - Why Privacy is Difficult
  Privacy: "Freedom from manipulation"--Jaron Lanier
  Privacy: "The right to be left alone."--Jaron Lanier
  Privacy: "Don't try to predict or understand me so that you can manipulate me."--Jaron Lanier
  The right to be left alone. Don't try to predict or understand me so
...
** Id: lanusse-01
- The AltLink is a PDF copy of the Medium article. This is because the
  article is behind Medium's paywall, so it cannot be archived
  directly.
** Id: le-01
...
** Id: oecd-01
- Search for: Citizens’ assemblies
- <blockquote>The OECD (Organisation for Economic Co-operation and
  Development) is a forum and knowledge hub for data, analysis and
  best practices in public policy. We work with over 100 countries
  across the world to build stronger, fairer and cleaner societies –
  helping to shape better policies for better lives.</blockquote>
...
- Perlman asks: "What if, instead of using our brains to devise
  conceptions of critical thinking, we eliminated the noise and
  revolutionized a way to teach people how to think better by tracing
  critical thinking back to its core evolutionary survival
  mechanisms?"
...
+ From GoodReads
  ...
  + https://web.archive.org/web/20260520040837/https://www.goodreads.com/book/show/18736925-capital-in-the-twenty-first-century
  - <blockquote>
    - What are the grand dynamics that drive the accumulation and
      distribution of capital? Questions about the long-term evolution
      of inequality, the concentration of wealth, and the prospects
      ...
      Century, Thomas Piketty analyzes a unique collection of data
      from twenty countries, ranging as far back as the eighteenth
    ...
    - Piketty shows that modern economic growth and the diffusion of
      knowledge have allowed us to avoid inequalities on the
      apocalyptic scale predicted by Karl Marx. But we have not
      modified the deep structures of capital and inequality as much
      as we thought in the optimistic decades following World War
      II. <b>The main driver of inequality—the tendency of returns on
      ...
      democratic values.</b> But economic trends are not acts of
      God. Political action has curbed dangerous inequalities in the
      past, Piketty says, and may do so again.</blockquote>

+ Capital in the Twenty-first Century by Thomas Piketty – review
  + There has been an intense debate about this surprise
    bestseller. What is the upshot?
  + https://www.theguardian.com/books/2014/jul/17/capital-twenty-first-century-thomas-piketty-review
  + https://web.archive.org/web/20260309020355/https://www.theguardian.com/books/2014/jul/17/capital-twenty-first-century-thomas-piketty-review
  + By Stephanie Flanders,  2014-07-17  
+ 'People are so disgusted' - Economist Thomas Piketty on why we need
  a wealth tax
  + https://www.youtube.com/watch?v=XeZoNTJgBZs
+ Thomas Piketty on Inequality and Capital in the 21st Century
  09/22/2014
  + https://www.youtube.com/watch?v=MOZJBKZqw40
+ The Dignity Deficit: Inequality, Work, & Recognition
  + https://www.youtube.com/watch?v=bMg-1raozPA

+ AI Was Never About Helping You | Cory Doctorow 2026-06-19
  + https://youtu.be/SPQNPJ0CEPo?si=tj6qfmk8xYRE4TQe&t=2385
  + Publisher: Galaxy Brain with Charlie Warzel
  - <blockquote>
    - How does this cycle break?
    - Well, about 15 years ago, I guess, there was a book by Tom
      Picetti, the French economist, called Capital in the 21st
      century. And Petti did this monumental research project going
      through every ledger of capital flows going back 300 years to
      trace capital flows and capital concentration over
      centuries. And their AI, Oligarchy, and Democracy conclusion was
      that all of the things being equal, capital tends to
      accumulate. that if you have money, you tend to make money. They
      they summarized this as R is greater than G. The rate of
      return of cap on capital is always greater than the rate of
      growth.
    - And so Petti's point was if you don't do something about that,
      rich people get richer and richer and richer and richer and
      richer and richer. Doesn't matter how big the pie is getting,
      the share of the pie owned by the rich gets bigger faster than
      the pie gets bigger always as an iron law. And that eventually
      this becomes untenable. Eventually, the rich, because they are
      unchecked, there is no democratic accountability, they are as
      subject to folly as the rest of us, they look to one another
      with great jealousy and use us as pawns in bids to take one
      another's fortunes once our fortunes have been stripped
      bare. that this creates ma massive instability and that those
      instabilities tip and he sees these points over and over again
      where the share of income in the top decile the top 10% reaches
      or wealth rather not income reaches a certain point, and then
      you get the French Revolution and then World War I and World War
      II and so on and so on.
    - His message was that unless we do something about oligarchy the
      end state of oligarchy is not stability The end state of
      oligarchy is chaos. It's collapse. And that is my worry.
    - You mentioned before, that there are these billionaires who love
      the fantasy of AI and love the fantasy of of a world without
      people and that they live in a world without people now where
      everyone around them is a non-player character who just glazes
      them with AI like nonsense.
    - But there's another group of people who love AI, which is
      politicians who want to exert their will without having to go
      through a permanent civil service. Just like there's a dream of
      a workplace without workers, there's a dream of a government
      without bureaucrats, right? This is what Trump wants to do with
      Doge. This was the whole nature of the Doge project was you take
      away the deep state, which is to say everyone who knows how the
      government works, and you replace them with chat bots, and then
      Trump has an idea, and it happens. You don't have these
      collisions with people like that's not just not how the
      government works. We can't do it that way. There people won't be
      able to fill in that form you want them to fill in. If you take
      away this support, this other thing will collapse. Doesn't
      doesn't work that way. You just tell the chatbot to do it and
      the chatbot just does it. You can see how this would be really
      unstable. I mean, we're living through it. We're living through
      it with just screw flies.  No amount of belief is going to help
      you when beef is $30 a pound; like that's politically
      destabilizing. And so I think that unless we can confront
      oligarchy by democratic means that we will find ourselves in the
      midst of a circumstance where it is being confronted by
      non-democratic means whether or not that's what we want or what
      we aim for. And I really worry about it. I think oligarchy, it
      is the force that stops us from addressing the poly crisis of
      genocide and climate degradation and rising authoritarianism.
      And until we meet that oligarchy challenge, I think we are going
      to struggle to do more than fight a holding action on everything
      else. And when we get rid of the oligarchs, it's still not going
      to be easy.
    </blockquote>
...
** Id: putnam-01
+ The full interview (audio) with a generated transcript can be found
  here: https://www.youtube.com/watch?v=sqZ4Po4vMAQ
+ One fundamental problem: young males

** Id: putnam-02
+ cautionary tail p336-p337 First Overcorrection, Second do not
  compromize on equality and inclusion.

** Id: putnam-03

** Id: putnam-04
+ The "leading indicator" of the I/We change is: culture and morality
   +https://www.youtube.com/watch?v=fxS35EppNfI&t=3660s
   + Things like Boy Scouts, Boy's club, fraternal organizations, etc.

** Id: putnam-05
+ The leading indicator of the I/We change is: culture and
   morality https://youtu.be/fxS35EppNfI?si=y7b2DyJPShoWrdoU&t=3660
   Things like Boy Scouts, Boy's club, fraternal organizations,
   etc.
...
https://tinyurl.com/yfpz5fud+
https://csu-calpoly.primo.exlibrisgroup.com/discovery/fulldisplay?docid=alma991000363459702920&amp;context=L&amp;vid=01CALS_PSU:01CALS_PSU&amp;lang=en%2F&amp;search_scope=Everything&amp;adaptor=Local%20Search%20Engine&amp;tab=Everything&amp;query=any,contains,senior%20project%20Bruce%20Rafnel&amp;offset=0
https://web.archive.org/web/20241010012700/https://csu-calpoly.primo.exlibrisgroup.com/discovery/fulldisplay?docid=alma991000363459702920&amp;context=L&amp;vid=01CALS_PSU:01CALS_PSU&amp;lang=en&amp;search_scope=Everything&amp;adaptor=Local%20Search%20Engine&amp;tab=Everything&amp;query=any,contains,senior%20project%20Bruce%20Rafnel&amp;offset=0
...
+ https://yourlogicalfallacyis.com/pdf/Logical_Fallacies_on_A4.pdf
  + https://web.archive.org/web/20250826223101/https://yourlogicalfallacyis.com/pdf/Logical_Fallacies_on_A4.pdf
...
Robins' studies found high rates of heroin use (34%) and symptoms of
heroin dependence (20%) among US soldiers while serving in Vietnam. In
the first year after returning to the United States only 1% became
re-addicted to heroin, although 10% tried the drug after their
return.{robins-01}

- Main Study: See: robins-01
...
AJPH: https://ajph.aphapublications.org/doi/pdf/10.2105/AJPH.64.12_Suppl.38

https://tinyurl.com/bdd822z9+
https://web.archive.org/web/20250810153230/https://ajph.aphapublications.org/doi/pdf/10.2105/AJPH.64.12_Suppl.38
...
** Id: russell-02
- "Behind Italy’s beauty (and parmesan) is a radical tradition of
  cooperatives. In some areas, they make up nearly a fifth of the
  GDP. We went to Emilia-Romagna, one of the richest regions in the
  country, to investigate how Italy’s workers built a more democratic
  economy."
...
** Id: schasfoort-01
- SOURCES: I've linked my sources in the blog that goes along with
  this video. Links are in the text.
  https://www.moneymacro.rocks/blog

- https://www.moneymacro.rocks/2025-12-15-guns/

- https://link.springer.com/article/10.1007/s10940-020-09490-6
  - Cite this article, but can't access behind paywall.<br>
  + Chalfin, A., Hansen, B., Lerner, J. et al. Reducing Crime Through
    Environmental Design: Evidence from a Randomized Experiment of
    Street Lighting in New York City. J Quant Criminol 38, 127–157
    (2022). https://doi.org/10.1007/s10940-020-09490-6
...
** Id: starhawk-02
- She visited a number of intentional communities in Europe.
- She lists elements for successful communities.
...
** Id: sullivan-01
*** My comment: 
- The main problem with our culture is its intolerance of behavior
  that is not gender aligned. Insisting that a person's body defines
  their gender role leads to the conclusion that the body needs to be
  changed if the person disagrees with that role. In some earlier
  cultures, the physical body was only one factor in the role a person
  had in a community.
- Where things get controversial is with sports. The male hormones do
  change a person's body to be stronger than it would be without those
  hormones. So, play in the sport that aligns with the hormones one
  experiences during puberty (natural or artificial).

*** From: PDXceptional, Portland, OR
- This is a problem with some nonprofits — once the problem has been
  “solved” they expand the definition of the problem to ensure
  relevance and continue the organization operations.
- It’s about ensuring the long-term stability of the organization
  versus solving a problem, declaring victory, and shutting
  down. Survival instinct, but is it good for the cause or even the
  nonprofit sector as a whole?

*** My thought:
- Yes! Even non-profits are not immune to the "survival instinct" of
  large organizations.

*** Another response: youtuber
- The New York Times Thinks Gays Have Gone Too Far
  + https://www.youtube.com/watch?v=vTyR3oIn6is
...
+ part4 - missing from YouTube
+ [[http://www.youtube.com/watch?v=FQfjEJaLGRI][part5]]
+ [[http://www.youtube.com/watch?v=Fi9sodp15F8][part6]] 
+ [[http://www.youtube.com/watch?v=HcLzaIFapS4][part7]]
+ part8 - missing from YouTube

- Another source:
  [[https://www.sustainable.soltechdesigns.com/a-planet-for-the-taking.html]]

- I found all the parts, and saved them at:
  https://moria.whyayh.com/rel/archive/video/public/a-planet-for-the-taking/
...
<blockquote> "Making a Career in Dictatorship," a new book by two
German political scientists, Adam Scharpf and Christian Glassel, reads
like what you might get if you crossed Hannah Arendt’s ideas about the
“banality of evil” with a business school guide on how to get the most
out of low performers.  </blockquote>

<blockquote> Mr. Glassel and Mr. Scharpf are concerned that President
Trump’s planned expansion of ICE, in particular, could make it an
ideal venue for “detouring” by ambitious underperformers who could be
deployed for anti-democratic purposes. The worry is especially
profound given the storming of the Capitol at the end of Mr. Trump’s
first term, albeit by a less organized band of loyalists.

The playbook for a leader to create a loyal security service, they
said, is to set up or repurpose an institution that can become a
“second ladder” for career promotions, resource it generously and
ensure that the barriers to getting hired there are low, signaling
that it offers career opportunities to those who cannot find them
...
** Id: weinberg-01
- Recommended size for teams: 9 to 12 people. (page?)
** Id: wheaton-01
# Old: mcmichael-01
...
- https://permies.com/wiki/bootcamp
  ...
  - the sepper program - rent a cabin
  - ant village - rent an acre for a year
...
** Id: wikipedia-68
- <blockquote>A potlatch is a gift-giving feast practiced by
  Indigenous peoples of the Pacific Northwest Coast of Canada and the
  United States.{wikipedia-68}</blockquote>

- <blockquote>The status of any given family is raised not by who has
  the most resources, but by who distributes the most resources. The
  hosts demonstrate their wealth and prominence through giving away
  goods.{wikipedia-68}</blockquote>

- <blockquote>Potlatching was made illegal in Canada in 1884 in an
  amendment to the Indian Act. To some extent, this was at the urging
  of missionaries and government agents who considered it "a worse
  than useless custom" that was seen as wasteful, unproductive, and
  contrary to 'civilized values' of
  accumulation.{wikipedia-68}</blockquote>
